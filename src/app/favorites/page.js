...
//   async function fetchFavorites(filters = {}) {
//     try {
//       const data = await api.get('/favorites', { auth: true, params: filters });
//       setFavorites(data);
...
//     result = result.filter((favorite) => filters.types.includes(favorite.listing.type));
//   }
//   if (filters.maxPrice) {
//     result = result.filter((favorite) => favorite.listing.price <= filters.maxPrice);
//   }
